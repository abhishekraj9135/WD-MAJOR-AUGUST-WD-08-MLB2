...
// javascript code to show weather condition
// api.openweathermap.org/data/2.5/forecast?q=Pune&appid=c5cd71c3d619dcaceb71e0ab4492a964   ->api call
...
const showTodayweather = (data) =>{
    ...
    <main id="main">
      <!-- search bar -->
      <div class="row1">
         <input type="search" class="search" id="search" placeholder="Go by City name">
